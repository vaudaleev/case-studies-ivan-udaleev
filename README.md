# Data Analytics Case Studies | Ivan Udaleev

Студент 1 курса (МиКН, ИИ). Специализируюсь на анализе данных, статистическом моделировании и data-driven решениях для бизнеса.
...
## 📬 Контакты
- vanya.udaleev@mail.ru
- Telegram: [@vaudaleev](https://t.me/vaudaleev)
- Центральный университет, МиКН (ИИ)
